...
public class LoginResponsePanel extends GridPane {
    private static final Long ONE_SECOND = 1_000_000L;

    private MainLoginFrame frame;

    private Label message;

    public LoginResponsePanel(MainLoginFrame frame) {
        this.frame = frame;
        init();
    }
    ...
    public void createPositive(String message, Long duration) {
        ...
        fader.setOnFinished((e) -> {
            frame.getLoginBodyPanel().refresh.func();
